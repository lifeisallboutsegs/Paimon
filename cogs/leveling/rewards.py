...
class LevelingRewards(commands.Cog):
    ...
    @rewards.command(name='add', description='Add a level-up reward!', help='Add a level-up reward! You must specify at least a role OR coins (or both).\nExamples:\n  !rewards add 10 @VIP\n  !rewards add 20 1000\n  !rewards add 30 @Legend 5000', usage='<level> [role_or_coins] [coins]', with_app_command=False)
    @is_owner_or_admin()
    ...
    @rewards.command(name='remove', description='Remove a level-up reward!', help='Remove a level-up reward for the specified level.\nExample: !rewards remove 10', usage='<level>')
