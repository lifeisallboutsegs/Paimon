...
class UtilityMisc(commands.Cog):
    ...
    @commands.hybrid_command(
        name="message", description="Send a message to a specific channel."
    )
    @commands.has_permissions(manage_messages=True)
    @app_commands.describe(
        channel="The channel to send to", message="The message to send"
    )
    ...
    @commands.hybrid_command(
        name="question", description="Ask the bot a yes/no question."
    )
